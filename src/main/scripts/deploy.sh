...
docker pull potic/potic-aggregator:latest

warn "Starting docker image..."
docker run -dit --name potic-aggregator --link pocket-square-articles -v /logs:/logs -p 40401:8080 potic/potic-aggregator:latest
